...
public class AuthenticatedActivityController extends AbstractController<Authenticated, Activity> {
	...
	@Autowired
	private AuthenticatedActivityListByInvestmentRoundService	listService;
	...
	private void initialise() {
		super.addCustomCommand(CustomCommand.LIST_BY_INVESTMENT_ROUNDS, BasicCommand.LIST, this.listService);
