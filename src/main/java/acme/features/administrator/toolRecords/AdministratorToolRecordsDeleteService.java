...
@Service
public class AdministratorToolRecordsDeleteService implements AbstractDeleteService<Administrator, ToolRecords> {
	...
	@Override
	public void delete(final Request<ToolRecords> request, final ToolRecords entity) {
		assert request != null;
		assert entity != null;
